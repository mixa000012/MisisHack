...
class Model:
    ...
    def _get_features(self, tokenized_texts):
        ...
        ordered_columns = ['backend_score', 'ml_score', 'mobyle_score', 'designer_score',
                           'analytic_score', 'frontend_score', 'len_words_stack',
                           'experience_techs']
...
rationg_system = Model(pca, kmeans, model)
print(rationg_system.get_predictions(dct))
